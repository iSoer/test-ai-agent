...
export default function App() {
  ...
  const handleRollbackAndResubmit = useCallback(
    async (messageId: string, newContent: string) => {
      ...
      if (msgIndex <= 0) {
        ...
        rollbackToMessage(messages[msgIndex - 1].id);
      }
      await handleSubmit(newContent);
    },
    [abortController, messages, rollbackToMessage, clearMessages, setAbortController, setAgentWorking, handleSubmit],
  );
  ...
  const handleDiscardChanges = useCallback(
    ...
    [abortController, messages, rollbackToMessage, clearMessages, setAbortController, setAgentWorking],
  );
      ...
      */}
      <div className="w-[30%] min-w-0 flex flex-col bg-sidebar border-r border-sidebar-border">
        ...
        <MessageList
          ...
          onRollbackAndResubmit={handleRollbackAndResubmit}
